    ...
    configure<PublishingExtension> {
        publications.withType<MavenPublication>().configureEach {
            ...
            this.pom {
                ...
                url.set("https://github.com/sanyavertolet/kotlin-js-preview-idea-plugin")
                licenses {
                    license {
                ...
                scm {
                    url.set("https://github.com/sanyavertolet/kotlin-js-preview-idea-plugin")
                    connection.set("scm:git:https://github.com/sanyavertolet/kotlin-js-preview-idea-plugin.git")
                    developerConnection.set("scm:git:git@github.com:sanyavertolet/kotlin-js-preview-idea-plugin.git")
                }
            }
        }
    }
